...
describe('package entrypoints', () => {
  test('package root re-exports the public API', async () => {
    ...
    expect(typeof pkg.writeFile).toBe('function')
    expect(typeof pkg.copyFile).toBe('function')
    expect(typeof pkg.readPage).toBe('function')
    expect(typeof pkg.formatDuration).toBe('function')
    expect(typeof pkg.downloadTemporaryFile).toBe('function')
    expect(typeof pkg.rotateTorIdentity).toBe('function')
    expect(typeof pkg.printPriceDiff).toBe('function')
    expect(typeof pkg.colorizeByHash).toBe('function')
